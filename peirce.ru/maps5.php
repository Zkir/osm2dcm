...
require_once("include/misc_utils.php"); 
  ...
  $zPage->WriteHtml( "На этой странице представлены карты OSM для СитиГид 5.x. Поскольку 5.x является устаревшей версией, эти карты больше обновляться не будут.");
