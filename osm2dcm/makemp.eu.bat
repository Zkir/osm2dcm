...
rem set SOURCE_FILE=euroroutes.osm
SET MAP_VERSION=%8
SET MAP_UID=%9
...
osmfilter d:\osm\osm_data\_src\%SOURCE_FILE% --keep= --keep-ways="( highway=*  or route=ferry ) and ( network=e-road or network=e-road:A or int_ref=E* or int_ref=Е* )" --keep-relations="route=road and ( network=e-road or network=E-road_link or network=e-road_link or ref=E* or int_ref=E* or ref=Е* or int_ref=Е*  ) " --emulate-osmosis >%WORK_PATH%\final.osm
...
echo upload validation results
